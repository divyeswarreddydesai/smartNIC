...
IGNORE:
    ...
    Task Management, Category Associations, Prism Central DR, API Batching  # noqa: E501

    OpenAPI spec version: 17.0.0-8355-RELEASE
...
class CategoriesApi(object):
    ...
    def get_associations_for_category(self, categoryExtId, _page=None, _limit=None, _filter=None, **kwargs):  # noqa: E501
        """.. deprecated:: This API has been deprecated.

        Fetch associations of a category. (This is an internal API) 

        >>> response = api.get_associations_for_category(categoryExtId, (optional) _page, (optional) _limit, (optional) _filter)

        This method makes a synchronous HTTP request by default. To make an asynchronous HTTP request, please pass async_req=True.

        >>> thread = api.get_associations_for_category(categoryExtId, async_req=True)
        >>> result = thread.get()

        :param categoryExtId: A globally unique identifier of an instance that is suitable for external consumption. 
        :type categoryExtId:
            :class:`str`, required
        ...
        :param kwargs: kwargs for the method.
                       The following can be passed for an asynchronous HTTP call::
                           ...
                           async_req=True
        :return: An instance of class :class:`~ntnx_prism_py_client.models.prism.v4.config.AssociationDetailApiResponse`.
        ...
        if ('categoryExtId' not in params or params['categoryExtId'] is None):
            raise ValueError("Missing the required parameter `categoryExtId` when calling `get_associations_for_category`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'categoryExtId' in params and params['categoryExtId'] is not None:
            path_params['categoryExtId'] = params['categoryExtId']  # noqa: E501
        ...
        extra_params.append('_preload_content')
        extra_params.append('_request_timeout')
        all_params = set(['categoryExtId', '_page', '_limit', '_filter'])
        all_params.update(extra_params)
        for key, val in six.iteritems(params):
            if val is not None and key.lower() not in self.__headers_to_skip and key not in all_params:
                if key.lower() == 'if_match'.lower():
        ...
        try:
            if kwargs.get('async_req'):
                return self.api_client._call_api(
                    '/api/prism/v4.0.b1/config/categories/{categoryExtId}/associations', 'GET',
                    path_params,
                    query_params,
                    header_params,
                    body=body_params,
